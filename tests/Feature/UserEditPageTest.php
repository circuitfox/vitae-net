...
class UserEditPageTest extends TestCase
{
    ...
    public function testHasUser()
    {
        ...
        $response->assertSee('<input type="hidden" class="form-control" id="name" name="name" required value="'.$user->name.'">');
        $response->assertSee('<input type="text" class="form-control" id="_name" name="_name" disabled value="'.$user->name.'">');

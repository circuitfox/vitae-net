...
class MedicationEditPageTest extends TestCase
{
    ...
    public function testHasForm()
    {
        ...
        $response->assertSee('<input class="form-control" type="number" name="dosage_amount" min="0" step="0.01" value="' . $medication->dosage_amount . '" id="med-dosage-amount" required>');

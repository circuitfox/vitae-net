...
class MedicationEditPageTest extends TestCase
{
    ...
    public function testHasForm()
    {
        ...
        $response->assertSee('<input class="form-control" type="number" name="dosage_amount" step="0.01" value="' . $medication->dosage_amount . '" id="med-dosage-amount" required>');
        ...
        $response->assertSee('<input class="form-control" type="number" name="second_amount" step="0.01" value="' . $medication->second_amount . '" id="med-second-amount">');

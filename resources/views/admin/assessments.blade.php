          ...
          <div class="panel-heading" role="tab">
            <div class="row">
              <div class="panel-title">
                <a class="accordion collapsed col-md-8" role="button" data-toggle="collapse" data-parent="#assessments" data-target="#assessment{{ $date }}">
                  <h3>{{ $date }}</h3>
                </a>
              </div>
            </div>
          </div>
          <div id="assessment{{ $date }}" class="panel-collapse collapse" role="tabpanel">

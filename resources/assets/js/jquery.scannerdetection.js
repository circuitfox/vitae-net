...
(function($){
    $.fn.scannerDetection=function(options){
        ...
        this.each(function(){
            var self=this, $self=$(self), firstCharTime=0, lastCharTime=0, stringWriting='', callIsScanner=false, testTimer=false, oldInput = '', elem = {};
            var initScannerDetection=function(){
                firstCharTime=0;
                stringWriting='';
                oldInput = $(document.activeElement).val();
